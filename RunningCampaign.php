...
<html class="no-js" lang="en" dir="ltr">
  <head>
    ...
    <title>Running a Campaign</title>
  ...
  <div class="holy-grail-grid">
      ...
      <div class="holy-grail-middle">
        ...
        <?php
          ...
          if ( $xlsx = SimpleXLSX::parse('RunningCampaign.xlsx') ) {
            foreach( $xlsx->rows() as $r ) {
              $TableColumn = (int) filter_var($r[0], FILTER_SANITIZE_NUMBER_INT);
              $r[0] = preg_replace('/\d/', '', $r[0] );
              switch ($r[0]) {
                case "Section":
