  ...
  <div class="holy-grail-grid">
      ...
      <div class="holy-grail-middle">
        ...
        <?php
          ...
          if ( $xlsx = SimpleXLSX::parse('Skills.xlsx') ) {
            foreach( $xlsx->rows() as $r ) {
              switch ($r[0]) {
                case "Section":
                  ...
                  break;
                case "TableStart":
                  echo '<table border="1" cellpadding="3" style="border-collapse: collapse"><tr><td>'.$r[2].'</td><td>'.$r[3].'</td><td>'.$r[4].'</td></tr>';
                  break;
                case "Table":
                  echo '<tr><td>'.$r[2].'</td><td>'.$r[3].'</td><td>'.$r[4].'</td></tr>';
                  break;
                case "TableEnd":
                  echo '<tr><td>'.$r[2].'</td><td>'.$r[3].'</td><td>'.$r[4].'</td></tr></table>';
                  break;
                case "italic":
